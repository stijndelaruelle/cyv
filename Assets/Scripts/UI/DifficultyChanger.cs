...
public class DifficultyChanger : MonoBehaviour
{
    ...
    private void Awake()
    {
        m_VisualDifficultyType = new string[6];
        m_VisualDifficultyType[0] = "Drunkard";  //Standard Easy
        m_VisualDifficultyType[1] = "Stranger";  //Standard Medium
        //m_VisualDifficultyType[2] = "Wizard";    //Standard Hard

        //m_VisualDifficultyType[3] = "Merchant";  //Aggressive Easy
        m_VisualDifficultyType[2] = "Sellsword"; //Aggressive Medium
        m_VisualDifficultyType[3] = "Knight";    //Aggressive Hard

        //m_VisualDifficultyType[6] = "Beggar";    //Defensive Easy
        m_VisualDifficultyType[4] = "Smuggler";  //Defensive Medium
        m_VisualDifficultyType[5] = "Banker";    //Defensive Hard
    }
